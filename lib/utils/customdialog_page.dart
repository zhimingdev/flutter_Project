...
class CustomDialog extends StatefulWidget {
  ...
  const CustomDialog({Key key, this.title, this.content, this.confirmContent, this.cancelContent,this.confirmTextColor, this.isCancel = true, this.confirmColor, this.cancelColor, this.outsideDismiss = true, this.confirmCallback, this.dismissCallback, this.image, this.imageHintText}) : super(key: key);
              ...
              children: <Widget>[
                Expanded(
                    child: widget.isCancel ? Container(
                      ...
                      child: FlatButton(
                        child: Text(
                            widget.cancelContent == null ? '取消' : widget.cancelContent,
                            style: TextStyle(
                              fontSize: 16.0,
